...
foreach(line ${LibInfo})
    ...
    if(${label_delimiter} GREATER 0)
        ...
        elseif(${has_maintainer} EQUAL 0)
            string(SUBSTRING ${line} ${label_delimiter} "-1" LibMaintainer)
        elseif(${has_sentence} EQUAL 0)
            string(SUBSTRING ${line} ${label_delimiter} "-1" LibDescription)
        elseif(${has_paragraph} EQUAL 0)
            string(SUBSTRING ${line} ${label_delimiter} "-1" LibParagraph)
        elseif(${has_url} EQUAL 0)
            string(SUBSTRING ${line} ${label_delimiter} "-1" LibUrl)
        endif()
    endif()
endforeach()
